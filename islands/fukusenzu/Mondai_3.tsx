    ...
    <>
      ...
      >
        <img
          ...
          alt="電気工事士の女の子の顔"
        />
        <h2 class="font-bold text-lg">タイムスイッチの接続（接地側）</h2>
        <div class="col-span-2 md:col-span-1 flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
          <p>
      ...
      >
        <img
          ...
          alt="電気工事士の女の子の顔"
        />
        <h2 class="font-bold text-lg">タイムスイッチの接続（非接地側）</h2>
        <div class="col-span-2 md:col-span-1 flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
          <p>
            非接地側は、スイッチを開閉する
            <span class="border-2 border-black rounded-full p-1 mx-1 w-8 h-8 inline-flex justify-center items-center">
      ...
      >
        <img
          ...
          alt="電気工事士の女の子の顔"
        />
        <h2 class="font-bold text-lg">コンセントのアースの接続</h2>
        <div class="col-span-2 md:col-span-1 flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
          <p>
      ...
      >
        ...
        <div class="col-span-2 md:col-span-1 flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
          <p>
            ジョイントボックス間の線が3本あります。接地側は白（図では青）で決まりですが残り2本のどちらかを赤にする必要があります。実際の試験では「施工条件」に指示があるため、よく「施工条件」を読みましょう。2025年度（令和7年度）上期の出題では、
            <em>
      ...
      <div
        class={`grid-cols-[56px_1fr] md:grid-cols-[96px_1fr] items-center gap-2.5 ${step === 0b100000000 ? "grid" : "hidden"}`}
      >
        <img
          class="w-14 h-14 md:w-24 md:h-24 md:row-span-2 self-start rounded-full"
          src="/electrician-2/electrician-girl-face.webp"
